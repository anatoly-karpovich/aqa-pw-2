...
export class SignInService {
  ...
  constructor(page: Page, token?: string, private service = new SignInApiClient()) {
  ...
  private async getTokenFromBrowser() {
    const token = (await this.homePage.getCookies()).find((cookie) => cookie.name === "Authorization");
